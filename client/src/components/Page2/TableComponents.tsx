...
export const ActivityTable: React.FC<TableComponentsProps> = ({
  ...
  const isEditableField = (field: keyof ActivityResponse): boolean => {
    // CHANGED: Added summary_Issue to the editable fields list
  ...
  const renderEditableCell = (activity: ActivityResponse, field: keyof ActivityResponse, value: any) => {
    if (isEditing(activity.id, field)) {
      // CHANGED: Enhanced edit mode for summary_Issue with larger text area
    ...
    // CHANGED: Added summary_Issue to use scrollable container with edit functionality
        ...
        >
          <TableHead>
            <TableRow sx={{ backgroundColor: '#f5f5f5' }}>
              ...
              {/* CHANGED: Summary Issue column - Now editable with scrollable container */}
            ...
            {loading ? (
              ...
              paginatedActivities.map((activity) => (
                ...
                >
                  ...
                  {/* CHANGED: Summary Issue - Now editable with scrollable container */}
                  <TableCell sx={{ padding: '6px 8px' }}>
